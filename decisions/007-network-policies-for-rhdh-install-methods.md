...
- **Egress policies**: Allow outbound traffic for:
  ...
  - Any additional egress (SCM providers, CI/CD systems, auth providers, etc.) is left to the user to allow via their own additive NetworkPolicy resources, since these destinations are deployment-specific
